...
var newOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, createdOrder;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(req.body.orderItems.length === 0)) return [3, 1];
...
var getOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, order_1.default.find({})];
            case 1:
                orders = _a.sent();
                res.send(orders);
                return [2];
